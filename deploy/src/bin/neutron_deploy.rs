...
async fn main() -> Result<(), Box<dyn Error>> {
    ...
    // in order to compile the circuit with knowledge of the cw20 address,
    // we write the file manually.

    // generate a source file with the new CW20 address
    let generated_addr_path = current_dir.join("circuits/circuit_a/core/src/consts.rs");
    let generated_addr_content = format!(
        "// DO NOT EDIT. This file is automatically generated by neutron_deploy.rs.\npub const CW20_ADDR: &str = \"{}\";",
        cw20_addr
    );
